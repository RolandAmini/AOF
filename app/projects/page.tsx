        ...
        <section className="relative bg-gradient-to-r from-green-900 via-green-400 to-green-600 text-white py-24">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <div className="flex items-center justify-center gap-2 text-green-200 font-semibold text-sm mb-4">
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="mb-4">
                      ...
                      {project.status && (
  <div className="absolute top-4 left-4">
    <span className={`px-4 py-2 rounded-full font-semibold text-sm ${getStatusColor(project.status ?? 'En cours')}`}>
      {project.status}
    </span>
  </div>
)}
